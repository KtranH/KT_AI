...
class AddReplyNotification extends Notification implements ShouldQueue, ShouldBroadcast
{
    use Queueable;
    protected $liker;
    protected $comment;
    /**
     * Tạo mới một thông báo trả lời bình luận
     * @param User $liker Người trả lời bình luận
     * @param Comment $comment Bình luận được trả lời
     */
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Có người trả lời bình luận của bạn')
            ->line($this->liker->name . ' đã trả lời bình luận "' . $this->comment->content . '" của bạn.')
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'type' => 'add_reply',
            'message' => $this->liker->name . ' đã trả lời bình luận "' . $this->comment->content . '" của bạn.',
    ...
    /**
     * Lấy avatar của người trả lời bình luận
     * @param User $liker Người trả lời bình luận
     * @return string Avatar của người trả lời bình luận
     */
