...
Mặc dù kho lưu trữ chính không cung cấp tài liệu API chính thức chi tiết, có một số nguồn cộng đồng như [ComfyUI Community Manual](https://github.com/comfyanonymous/ComfyUI/wiki), nhưng không tìm thấy thông tin cụ thể về API trong lần kiểm tra này. Ngoài ra, có một yêu cầu tài liệu API trên GitHub tại [API documentation Issue](https://github.com/comfyanonymous/ComfyUI/issues/123), cho thấy nhu cầu về tài liệu chính thức, nhưng chưa có phản hồi rõ ràng.
