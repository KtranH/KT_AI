        ...
        <div class="flex items-center space-x-4">
          ...
          <template v-else-if="!isAuthenticated">
            <router-link 
              to="/login" 
              :class="[
                'flex items-center gap-2 px-4 py-2 text-sm font-medium transition rounded-full shadow-sm',
                isHomePage 
            ...
            <router-link 
              to="/register" 
              :class="[
                'flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-full transition shadow-sm',
                isHomePage 
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 11c1.657 0 3-1.343 3-3S13.657 5 12 5s-3 1.343-3 3 1.343 3 3 3zm0 2c-2.67 0-8 1.337-8 4v2a1 1 0 001 1h14a1 1 0 001-1v-2c0-2.663-5.33-4-8-4z" />
              </svg>
