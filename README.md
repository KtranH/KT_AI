...
![Banner KT_AI](https://via.placeholder.com/1200x300?text=KT_AI+Banner)

## Giới thiệu

KT_AI là một ứng dụng web hiện đại cho phép người dùng tạo và quản lý hình ảnh sử dụng trí tuệ nhân tạo thông qua ComfyUI. Dự án này kết hợp sức mạnh của các công nghệ web tiên tiến với hệ thống AI hiệu suất cao, mang lại trải nghiệm người dùng mượt mà và thời gian phản hồi nhanh chóng.
...
- Thiết kế kiến trúc microservice hiệu quả
...
- **Theo dõi tiến trình thời gian thực**: Cập nhật tiến độ tạo ảnh theo thời gian thực
...
### Trang chủ
![Trang chủ](https://via.placeholder.com/800x400?text=Trang+chu+KT_AI)

### Tạo ảnh
![Tạo ảnh](https://via.placeholder.com/800x400?text=Tao+anh+AI)

### Thư viện ảnh
![Thư viện ảnh](https://via.placeholder.com/800x400?text=Thu+vien+anh)

### Thống kê người dùng
![Thống kê](https://via.placeholder.com/800x400?text=Thong+ke)
